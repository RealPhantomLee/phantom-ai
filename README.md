...
`phantom-ai` is a specialized AI agent running on the `core` node (100.93.114.9 on Tailscale) with:
...
### `core` (100.93.114.9, Arch Linux, 12c/32GB)
...
### `aipi` (100.76.179.112, Raspberry Pi 5)
...
```
┌─────────────────────────────────────────────────┐
│ core (100.93.114.9) — phantom-ai orchestrator  │
│                                                 │
